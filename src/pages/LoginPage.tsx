        ...
        try {
            ...
            if (data.user) {
                ...
                if (userData.role !== role) {
                    // Role mismatch, sign them out and show an error
                    await supabase.auth.signOut();
        ...
        <div className="min-h-screen bg-slate-50 dark:bg-[#111a21] flex flex-col font-display transition-colors duration-300">
            ...
            <header className="w-full px-6 lg:px-20 py-6 flex justify-between items-center bg-transparent">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <button onClick={() => navigate('/signup')} className="bg-[var(--color-mint)]/40 hover:bg-[var(--color-mint)]/60 text-slate-800 px-6 py-2 rounded-full text-sm font-semibold transition-colors duration-200">
                        Create Account
                    </button>
                </div>
            </header>
